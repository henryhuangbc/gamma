...
async function fetchProjects() {
    try {
        var projects = []
        var githubFetch = await fetch("https://api.github.com/users/henryhuangbc/repos?sort=updatedd&per_page=1000")
        ...
        var codepenFetch = await fetch("https://codepen.io/henryhuangbc/public/feed")
